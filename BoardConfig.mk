...
#
BOARD_PATH := device/asus/ZS620KL
...
TARGET_OTA_ASSERT_DEVICE := ZS620KL
...
BOARD_KERNEL_CMDLINE += console=ttyMSM0,115200n8 earlycon=msm_geni_serial,0xA84000 buildv=WW_user_80.11.37.86_20180706 buildvariant=user
...
BOARD_ROOT_EXTRA_FOLDERS := firmware bt_firmware odm persist
...
TARGET_PREBUILT_KERNEL := device/asus/ZS620KL/Image.gz-dtb
